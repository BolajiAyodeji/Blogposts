...
datePublished: Wed Feb 13 2019 23:00:00 GMT+0000 (Coordinated Universal Time)
cuid: ck28x762700143ns1l1jm84ur
slug: introduction-to-babel-and-javascript-bundlers
cover: https://cdn.hashnode.com/res/hashnode/image/upload/v1572175417497/KA39bJjNc.png
tags: programming, javascript, babel

---

As earlier stated in my [previous
article](https://bolajiayodeji.com/introduction-to-es6-modules-49956f580da) ES6 modules is a very powerful concept. Although support is not available everywhere yet, a common way of using it is to transpile into ES5. You can use [Grunt](https://gruntjs.com/), [Gulp](https://gulpjs.com/),
[Webpack](https://webpack.js.org/), [Babe](https://babeljs.io/)l or some other transpiler to compile the modules during a build process.
...
> transformers. These plugins allow you to use the new syntax, right now without
...
A great way to work with Babel in the browser is to use code bundlers
