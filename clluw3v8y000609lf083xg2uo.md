...
I'm back in the job market and hunting for my next gig! I'm keeping an open mind about the type of company and technology industry I'd like to work with next; however, I'm looking for a full-time **Developer Advocate**, **Developer Relations Engineer**, **Developer Experience Engineer**, **Developer Relations Program Manager**, **Solutions Engineer**, **Technical Writer**, **Documentation Engineer**, **Community Manager**, or other similar developer/customer success roles with focus on developer relations/education, technical integrations (JavaScript/Python), documentation, content production/marketing, and developer programs/community management.
