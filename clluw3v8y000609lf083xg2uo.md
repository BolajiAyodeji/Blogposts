...
I'm officially back in the job market and hunting for my next gig! I'm keeping an open mind about the type of company and technology industry I'd like to work with next; however, I'm looking for full-time remote **Developer Advocate**, **Developer Relations Engineer**, **Developer Experience Engineer**, **Solutions Engineer**, **Technical Writer**, or **Documentation Engineer** roles with a strong focus on technical integrations (JavaScript/Python), developer education, open-source, documentation, content production/marketing, developer programs management, workshops/public speaking, and developer community management.
