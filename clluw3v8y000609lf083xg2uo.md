...
I'm back in the job market and hunting for my next gig! I'm keeping an open mind about the type of company and technology industry I'd like to work with next; however, I'm looking for a full-time **Developer Advocate**, **Developer Relations Engineer**, **Developer Experience Engineer**, **Solutions Engineer**, **Technical Writer**, **Documentation Engineer**, or other similar developer/customer success roles with a strong focus on technical integrations (JavaScript/Python), developer relations/education, documentation, content production/marketing, and developer programs/community/customer management.
